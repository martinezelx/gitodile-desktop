...
describe("frontend architecture guard, on src-shaped input", () => {
  ...
  it("does not report a cycle whose path runs through an erased type import", () => {
    // `runtime/project/sessions.ts` type-imports a feature barrel. At runtime
    // the cycle does not exist, and reporting it is what buried the real
    // findings.
    ...
    const violations = findArchitectureViolations(
      graph([
        {
          source: "src/runtime/project/sessions.ts",
          dependencies: [
            {
              ...
              cycle: [
                ...
                { name: "src/runtime/project/sessions.ts" },
              ],
            },
          ],
        },
      ...
      graph([
        {
          ...
          dependencies: [{ module: "./app/App", resolved: "src/app/App.tsx", dependencyTypes: RUNTIME }],
        },
        {
        ...
        },
        {
          ...
          dependencies: [
            {
              module: "../../shared/file-icons",
              resolved: "src/shared/file-icons/index.ts",
              dependencyTypes: RUNTIME,
            },
          ],
        },
