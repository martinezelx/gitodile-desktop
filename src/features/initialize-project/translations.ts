...
const en: InitializeProjectTranslations = {
  ...
  initializeNameHelp: "GitOdrile creates exactly this new folder and never replaces an existing path.",
  ...
  initializeSafetyBody: "GitOdrile rechecks the path immediately before writing, never cleans or repopulates an existing folder, and removes only exact empty artifacts marked as owned by this attempt.",
  ...
  initializeCleanupDescription: "An exact GitOdrile ownership marker could not be removed. Retry only that bounded cleanup before opening.",
  ...
  initializeOpeningDescription: "GitOdrile is opening the verified folder through the normal project session.",
  ...
  initializeOpenFailedDescription: "The verified folder remains on disk. Open it manually or retry from GitOdrile.",
  ...
  initializeRemoteCredentials: (expectation) => ({
    ...
    "git-credential-helper": "Future HTTPS actions use your configured Git credential helper. GitOdrile does not store credentials.",
    "ssh-agent-or-key": "Future SSH actions use your system SSH agent, keys, and host trust. GitOdrile does not store private keys.",
  })[expectation],
...
const es: InitializeProjectTranslations = {
  ...
  initializeNameHelp: "GitOdrile crea exactamente esta carpeta nueva y nunca reemplaza una ruta existente.",
  ...
  initializeCleanupDescription: "No se pudo eliminar un marcador exacto de propiedad de GitOdrile. Reintenta solo esa limpieza acotada antes de abrir.",
  ...
  initializeOpeningDescription: "GitOdrile está abriendo la carpeta verificada mediante la sesión normal del proyecto.",
  ...
  initializeOpenFailedDescription: "La carpeta verificada sigue en el disco. Ábrela manualmente o reintenta desde GitOdrile.",
  ...
  initializeRemoteCredentials: (expectation) => ({
    ...
    "git-credential-helper": "Las acciones HTTPS futuras usan tu gestor de credenciales Git configurado. GitOdrile no guarda credenciales.",
    "ssh-agent-or-key": "Las acciones SSH futuras usan el agente, claves y confianza de host del sistema. GitOdrile no guarda claves privadas.",
  })[expectation],
