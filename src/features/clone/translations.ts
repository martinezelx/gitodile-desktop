...
const en: CloneTranslations = {
  ...
  cloneNameHelp: "GitOdrile creates this folder only after the clone has been verified.",
  ...
  cloneLocalEffects: "GitOdrile uses a private staging folder, verifies the checkout, then publishes it only if the destination is still unused.",
  ...
  cloneCredentialsHelper: "Private HTTPS projects use your configured Git credential helper. GitOdrile does not store the credential.",
  cloneCredentialsSsh: "SSH uses your system host trust, agent, and keys. GitOdrile will not accept a host key automatically.",
  cloneSafetyTitle: "If you cancel",
  cloneSafetyBody: "GitOdrile stops Git and removes only the staging folder carrying this attempt's ownership marker. An existing destination is never removed.",
  cloneConfirmAction: "Clone and open project",
  cloneEditAction: "Edit details",
  cloneProgressTitle: "Cloning project",
  cloneProgressDescription: "Keep GitOdrile open while the remote data is downloaded and checked.",
  ...
  cloneCleanupDescription: "The verified project is in place, but GitOdrile could not remove its empty staging container. Clean that marked path before opening.",
  cloneCleanupAction: "Retry safe cleanup",
  cloneCleaningUp: "Cleaning up…",
  cloneOpeningTitle: "Opening the verified project",
  cloneOpeningDescription: "The clone is complete. GitOdrile is creating its normal project session now.",
...
const es: CloneTranslations = {
  ...
  cloneNameHelp: "GitOdrile solo crea esta carpeta después de verificar el clon.",
  ...
  cloneLocalEffects: "GitOdrile usa una carpeta privada temporal, verifica la copia y solo la publica si el destino sigue libre.",
  ...
  cloneCredentialsHelper: "Los proyectos HTTPS privados usan tu gestor de credenciales de Git. GitOdrile no guarda la credencial.",
  cloneCredentialsSsh: "SSH usa la confianza de hosts, el agente y las claves del sistema. GitOdrile no aceptará una clave de host automáticamente.",
  cloneSafetyTitle: "Si cancelas",
  cloneSafetyBody: "GitOdrile detiene Git y elimina únicamente la carpeta temporal marcada como propiedad de este intento. Nunca elimina un destino existente.",
  cloneConfirmAction: "Clonar y abrir proyecto",
  cloneEditAction: "Editar datos",
  cloneProgressTitle: "Clonando proyecto",
  cloneProgressDescription: "Mantén GitOdrile abierto mientras se descargan y verifican los datos remotos.",
  cloneProgressPhase: (phase) => ({
  ...
  cloneCleanupDescription: "El proyecto verificado ya está en su destino, pero GitOdrile no pudo eliminar su contenedor temporal vacío. Limpia esa ruta marcada antes de abrir.",
  cloneCleanupAction: "Reintentar limpieza segura",
  cloneCleaningUp: "Limpiando…",
  cloneOpeningTitle: "Abriendo el proyecto verificado",
  cloneOpeningDescription: "La clonación ha terminado. GitOdrile está creando ahora su sesión normal de proyecto.",
