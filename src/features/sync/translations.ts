...
const en: SyncTranslations = {
  ...
  getTeamFastForwardDescription: "GitOdile will only move straight ahead. It will not merge, rebase, stash, force, or resolve overlaps automatically.",
  ...
  getTeamUncertainDescription: "GitOdile could not prove the final local state, so it did not try to repair or repeat anything.",
...
const es: SyncTranslations = {
  ...
  getTeamFastForwardDescription: "GitOdile solo avanzará en línea recta. No combinará, reorganizará, apartará, forzará ni resolverá solapamientos automáticamente.",
  ...
  getTeamUncertainDescription: "GitOdile no pudo demostrar el estado local final, así que no intentó reparar ni repetir nada.",
