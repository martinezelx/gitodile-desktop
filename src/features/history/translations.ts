...
const en: HistoryTranslations = {
  ...
  historyErrorLoading: "GitOdrile couldn’t read this project’s saved versions.",
...
const es: HistoryTranslations = {
  ...
  historyErrorLoading: "GitOdrile no pudo leer las versiones guardadas de este proyecto.",
