...
export const APP_ERROR_CODES = [
  ...
  "invalid_clone_source", "invalid_clone_destination", "clone_destination_exists",
  ...
  "missing_identity", "empty_title", "invalid_title", "stale_preview", "stale_history_cursor", "hook_rejected",
...
export function localizeAppError(error: unknown, t: SharedTranslations, fallback: string): string {
  ...
  const messages: Record<AppError["code"], string> = {
    ...
    invalid_clone_source: t.errorInvalidCloneSource,
    invalid_clone_destination: t.errorInvalidCloneDestination,
    clone_destination_exists: t.errorCloneDestinationExists,
    clone_destination_collides: t.errorCloneDestinationCollides,
    stale_clone_plan: t.errorStaleClonePlan,
    clone_operation_busy: t.errorCloneOperationBusy,
    clone_operation_missing: t.errorCloneOperationMissing,
    clone_verification_failed: t.errorCloneVerificationFailed,
    clone_publish_uncertain: t.errorClonePublishUncertain,
    ...
    remote_not_found: t.errorRemoteNotFound,
    disk_full: t.errorDiskFull,
    permission_denied: t.errorPermissionDenied,
    path_too_long: t.errorPathTooLong,
    ...
    stale_history_cursor: t.errorStaleHistoryCursor,
