...
builds repeat their textual channel badge there; stable builds show only the
version. Version, channel and update line all come from the same release model
